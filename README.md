...
> Plataforma web que utiliza Inteligência Artificial local (Ollama) para traduzir, limpar e categorizar descrições confusas de faturas de cartão de crédito, oferecendo gestão e controle financeiro completo.
